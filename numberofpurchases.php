   ...
   <?php if ($session->logged_in) {?>
    ...
    <div class="search-bar mt-3">
        ...
        <form class="form-inline w-100 d-flex justify-content-between" id="searchForm">
            ...
            <div class="form-group mx-2 flex-fill position-relative col-12 col-md-2">
                <i class="fas fa-cogs position-absolute left-0 top-50 translate-middle-y mx-2"></i>
                <input
                    type="text"
                    id="unitprice"
                    class="form-control form-control-sm w-100 pl-5"
...
<style>
 ...
 $(document).ready(function() {
    ...
    function loadTable() {
        $.ajax({
            url: "ajax-load-purchases.php", // The server-side script
            type: "POST",
    ...
    $("#supplier_name").on("keyup", function() {
        ...
        if (searchTerm.length > 0) {
            $.ajax({
                url: "ajax-live-search-purchases.php", // Optional search script
                type: "POST",
     ...
     $("#purchase_date").on("keyup", function() {
      ...
      $("#unitprice").on("keyup", function() {
       ...
       $("#payment_duedate").on("keyup", function() {
        const searchTerm = $(this).val().trim();
