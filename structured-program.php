    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="text-center fade-in">
            <h1 class="text-5xl md:text-6xl font-extrabold mb-4">
                Structured Roadmap Program
            </h1>
            <p class="text-xl md:text-2xl max-w-3xl mx-auto mb-8">
                Follow a guided, step-by-step roadmap to progress from beginner to industry-ready professional with practical projects and mentor guidance.
            </p>
            <!-- <a href="admission.php" class="inline-block bg-white text-blue-700 font-semibold px-8 py-4 rounded-lg hover:bg-blue-50 transition">
                Apply Now
            </a> -->
        </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            ...
            <p class="text-gray-600 max-w-3xl mx-auto">
                Our Structured Roadmap Program is designed to take learners on a clear journey from foundational concepts to advanced expertise, ensuring measurable progress at every stage.
            </p>
        </div>
        ...
        <div class="grid md:grid-cols-3 gap-8">
            <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition">
                ...
                <p class="text-gray-600">6-12 months with milestone-based progression to master each skill effectively.</p>
            </div>
            <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition">
                <h3 class="text-2xl font-bold mb-3">Mode</h3>
                <p class="text-gray-600">Online learning with live sessions, mentorship, and self-paced project work.</p>
            </div>
            <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition">
                <h3 class="text-2xl font-bold mb-3">Eligibility</h3>
                <p class="text-gray-600">Beginners, students, graduates, and professionals seeking structured skill development.</p>
            </div>
        </div>
    </div>
</section>

<!-- Why Choose Structured Roadmap -->
<section class="py-20 bg-gradient-to-r from-blue-50 to-indigo-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            <h2 class="text-4xl font-bold text-gray-900 mb-4">Why Choose This Program?</h2>
            <p class="text-gray-600 max-w-3xl mx-auto">
                With a clear roadmap, structured milestones, and hands-on projects, learners can confidently develop skills that are immediately applicable in real-world settings.
            </p>
        </div>

        <div class="grid md:grid-cols-3 gap-8">
            <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition">
                <h3 class="text-2xl font-bold mb-3">Step-by-Step Learning</h3>
                <p class="text-gray-600">Follow a sequential path from core concepts to advanced skills, ensuring nothing is missed.</p>
            </div>
            <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition">
                <h3 class="text-2xl font-bold mb-3">Mentor Support</h3>
                <p class="text-gray-600">Get guidance, feedback, and mentorship at each milestone for better learning outcomes.</p>
            </div>
            <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition">
                <h3 class="text-2xl font-bold mb-3">Portfolio Development</h3>
                <p class="text-gray-600">Complete real projects to build a strong portfolio that demonstrates your skills to employers or clients.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="py-20 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            <h2 class="text-4xl font-bold text-gray-900 mb-4">Roadmap Milestones</h2>
            <p class="text-gray-600 max-w-3xl mx-auto">
                Our structured roadmap is divided into actionable milestones with measurable outcomes to ensure steady progress.
            </p>
        </div>

        <div class="space-y-8">
            <!-- Milestone 1 -->
            <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition flex items-start space-x-6">
                <div class="flex-shrink-0">
                    <span class="bg-blue-600 text-white font-bold rounded-full px-4 py-2">1</span>
                </div>
                <div>
                    <h3 class="text-2xl font-bold mb-2">Foundational Skills</h3>
                    <p class="text-gray-600">Learn core concepts, essential tools, and fundamentals to build a strong base.</p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition flex items-start space-x-6">
                <div class="flex-shrink-0">
                    <span class="bg-blue-600 text-white font-bold rounded-full px-4 py-2">2</span>
                </div>
                <div>
                    <h3 class="text-2xl font-bold mb-2">Intermediate Projects</h3>
                    <p class="text-gray-600">Apply your knowledge through practical projects with mentor feedback.</p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition flex items-start space-x-6">
                <div class="flex-shrink-0">
                    <span class="bg-blue-600 text-white font-bold rounded-full px-4 py-2">3</span>
                </div>
                <div>
                    <h3 class="text-2xl font-bold mb-2">Advanced Skills & Real Projects</h3>
                    <p class="text-gray-600">Engage in complex projects that simulate real industry scenarios for mastery.</p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition flex items-start space-x-6">
                <div class="flex-shrink-0">
                    <span class="bg-blue-600 text-white font-bold rounded-full px-4 py-2">4</span>
                </div>
                <div>
                    <h3 class="text-2xl font-bold mb-2">Portfolio & Career Launch</h3>
                    <p class="text-gray-600">Finalize projects, create your portfolio, and receive guidance to launch your career or freelancing journey.</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="hero-gradient text-white text-center py-24">
    <h2 class="text-5xl font-extrabold mb-6">Follow the Roadmap, Achieve Your Goals</h2>
    <p class="text-blue-100 mb-10 max-w-3xl mx-auto">
        Join now and follow a structured path to become industry-ready with hands-on projects and mentorship support.
    </p>
    <a href="admission.php" class="inline-block bg-white text-blue-700 font-semibold px-10 py-5 rounded-lg hover:bg-blue-50 transition">
        Apply Now
    </a>
</section>
