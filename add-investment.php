...
<?php endif; ?>
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="section-block" id="basicform">
                                    <h3 class="section-title text-center">Add Investment</h3>
                                  
                                </div>
                                <div class="card">
                                    <h5 class="card-header">Create New Investment</h5>
                                    <div class="card-body">
                                    <form action="process.php" method="POST" enctype="multipart/form-data">
    <div class="form-group">
        <label for="company_name" class="col-form-label">Company Name</label>
        <input type="text" name="company_name" class="form-control" placeholder="Enter company name">
        <p><?php echo $form->error("company_name"); ?></p>
    </div>

    <div class="form-group">
        <label for="payment_date" class="col-form-label">Payment Date</label>
        <input type="date" name="payment_date" class="form-control">
        <p><?php echo $form->error("payment_date"); ?></p>
    </div>

    <div class="form-group">
        <label for="amount_paid" class="col-form-label">Amount Paid</label>
        <input type="number" name="amount_paid" class="form-control" placeholder="Enter amount paid">
        <p><?php echo $form->error("amount_paid"); ?></p>
    </div>
    ...
    <div class="form-group">
        ...
        <p><?php echo $form->error("location"); ?></p>
    </div>

    <div class="form-group">
        <label for="investment_number_id" class="col-form-label">Investment Number ID</label>
        <input type="text" name="investment_number_id" class="form-control" placeholder="Enter investment number ID">
        <p><?php echo $form->error("investment_number_id"); ?></p>
    </div>
   ...
   <div class="text-center">
                                    <input type="submit" class="btn btn-danger " value="Add Investment" style="width: 30%; ">
                                    </div>
</form>
