...
<body>
   <?php if ($session->logged_in) {?>
    ...
    <div class="search-bar mt-2">
        ...
        <form class="form-inline w-100 d-flex justify-content-center" id="searchForm">
            <div class="form-group mx-2 flex-fill  col-12 col-md-3">
...
<style>
 ...
 $(document).ready(function() {
    ...
    function loadTable() {
        $.ajax({
            url: "ajax-load-users.php", // The server-side script
            type: "POST",
    ...
    $("#company_name").on("keyup", function() {
        ...
        if (searchTerm.length > 0) {
            $.ajax({
                url: "ajax-live-search-students.php", // Optional search script
                type: "POST",
