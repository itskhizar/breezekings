...
<div class="container mt-4">
    ...
    <h3 class="mb-4">
        Reurned Students – <span class="text-primary"><?php echo $data['excercise_title']; ?></span>
    </h3>

    <div class="card">
        <div class="card-header bg-success text-white">
            Students Who Reurned This Exercise
        </div>
    ...
    LEFT JOIN students s ON t.student_id = s.id
    WHERE t.excercise_id = '$exercise_id'
      AND LOWER(REPLACE(t.status, ' ', '_')) = 'Returned'
    ORDER BY t.submitted_at DESC
");
    ...
    while ($row = mysqli_fetch_assoc($turnedQuery)) {
        ...
        <tr>
            ...
            <td><span class='badge bg-primary text-white'>".$row['status']."</span></td>
    ...
    <tr>
        <td colspan='6' class='text-center p-3 text-muted'>
            No students have returned  this exercise yet.
        </td>
    </tr>
    ";
}
