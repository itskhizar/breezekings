   ...
   <?php if ($session->logged_in) {?>
    ...
    <div class="search-bar mt-3">
        ...
        <form class="form-inline w-100 d-flex justify-content-between" id="searchForm">
            ...
            <div class="form-group mx-2 flex-fill position-relative">
                <i class="fas fa-globe position-absolute left-0 top-50 translate-middle-y mx-2"></i>
                <input
                    type="text"
                    id="source"
                    class="form-control form-control-sm w-100 pl-5"
            ...
            <div class="form-group mx-2 flex-fill position-relative">
                <i class="fas fa-circle-notch position-absolute left-0 top-50 translate-middle-y mx-2"></i>
                <input
                    type="text"
                    id="status"
                    class="form-control form-control-sm w-100 pl-5"
...
<style>
 ...
 $(document).ready(function() {
    ...
    function loadTable() {
        $.ajax({
            url: "ajax-load-inventories.php", // The server-side script
            type: "POST",
    ...
    $("#product_name").on("keyup", function() {
        ...
        if (searchTerm.length > 0) {
            $.ajax({
                url: "ajax-live-search-inventories.php", // Optional search script
                type: "POST",
