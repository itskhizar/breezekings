    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="text-center fade-in">
            ...
            <p class="text-xl md:text-2xl max-w-3xl mx-auto mb-8">
                Gain real-world skills and guidance from industry experts to accelerate your career.
            </p>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            ...
            <p class="text-gray-600 max-w-3xl mx-auto">
                This mentorship program is designed for ambitious learners seeking hands-on experience, guided by seasoned industry professionals.
            </p>
        </div>
        ...
        <div class="grid md:grid-cols-3 gap-8">
            <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition">
                ...
                <p class="text-gray-600">6 to 12 weeks of intensive mentorship tailored to your learning pace.</p>
            </div>
            <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition">
                <h3 class="text-2xl font-bold mb-3">Mode</h3>
                <p class="text-gray-600">Hybrid learning: online sessions and optional on-site guidance with weekly check-ins.</p>
            </div>
            <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition">
                <h3 class="text-2xl font-bold mb-3">Eligibility</h3>
                <p class="text-gray-600">Open to students, graduates, and professionals aiming to enhance their skills.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="py-20 bg-gradient-to-r from-purple-50 to-pink-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            <h2 class="text-4xl font-bold text-gray-900 mb-4">Why Join This Program?</h2>
            <p class="text-gray-600 max-w-3xl mx-auto">
                Our mentorship bridges the gap between theory and practice, ensuring participants gain experience that employers value.
            </p>
        </div>

        <div class="grid md:grid-cols-3 gap-8">
            <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition">
                <h3 class="text-2xl font-bold mb-3">Hands-On Projects</h3>
                <p class="text-gray-600">Work on real industry projects with direct guidance from expert mentors.</p>
            </div>
            <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition">
                <h3 class="text-2xl font-bold mb-3">One-on-One Mentorship</h3>
                <p class="text-gray-600">Receive personalized advice and feedback tailored to your career goals.</p>
            </div>
            <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition">
                <h3 class="text-2xl font-bold mb-3">Portfolio & Networking</h3>
                <p class="text-gray-600">Build a strong portfolio and connect with industry leaders for future opportunities.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="py-20 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            ...
            <p class="text-gray-600 max-w-3xl mx-auto">
                The program is divided into structured stages for maximum learning impact.
            </p>
        </div>

        <div class="grid md:grid-cols-3 gap-8">
            <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition">
                <h3 class="text-2xl font-bold mb-3">Stage 1: Orientation</h3>
                <p class="text-gray-600">Introduction to the program, goal setting, and understanding expectations.</p>
            </div>
            <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition">
                <h3 class="text-2xl font-bold mb-3">Stage 2: Skill Development</h3>
                <p class="text-gray-600">Acquire core skills through guided lessons and exercises specific to your track.</p>
            </div>
            <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition">
                <h3 class="text-2xl font-bold mb-3">Stage 3: Real-World Projects</h3>
                <p class="text-gray-600">Apply your learning on real projects and receive mentor feedback to refine your skills.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="hero-gradient text-white text-center py-24">
    <h2 class="text-5xl font-extrabold mb-6">Ready to Boost Your Career?</h2>
    <p class="text-purple-100 mb-10 max-w-3xl mx-auto">
        Join our mentorship program and get step-by-step guidance from industry experts to become job-ready or start freelancing with confidence.
    </p>
