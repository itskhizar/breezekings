...
<body>
            ...
            <div class="dashboard-wrapper">
                <div class="container-fluid dashboard-content">
                    ...
                    <!-- <div class="page-header-modern">
                        <h2><i class="fas fa-user-graduate mr-2"></i>Students Management</h2>
 ...
 $(document).ready(function() {
    ...
    function loadTable() {
        $.ajax({
            url: "ajax-load-sessions.php", // The server-side script
            type: "POST",
    ...
    $("#search").on("keyup", function() {
        ...
        if (searchTerm.length > 0) {
            $.ajax({
                url: "ajax-live-search-classes.php", // Optional search script
                type: "POST",
...
<script src="https://code.jquery.com/jquery-3.7.1.min.js"></script>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                             <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="edit_start_time" name="start_time" placeholder="10:00 AM" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">End Time</label>
                                <input type="text" class="form-control" id="edit_end_time" name="end_time" placeholder="12:00 PM" required>
                            </div>
                        </div>
                        ...
                        <div class="row">
                             <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="edit_class_id" name="class_id">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Category ID</label>
                                <input type="text" class="form-control" id="edit_category_id" name="category_id">
                            </div>
                        </div>
                        -->

                        <!-- Note: Ideally, these IDs (Course, Teacher, etc.) should be dropdowns populated from DB. 
                             For now, keeping them as hidden or basic inputs if not strictly editable here, 
                             or assuming user might not want to change complex relations purely via this quick edit.
                             If full editing is needed, we need to fetch dropdown options. -->
    ...
    <script>
        function openEditModal(btn) {
            ...
            $('#edit_slots').val($(btn).data('slots'));
            $('#edit_start_time').val($(btn).data('start-time'));
            $('#edit_end_time').val($(btn).data('end-time'));
            
            // Hidden fields
            $('#edit_class_id').val($(btn).data('class-id'));
            $('#edit_category_id').val($(btn).data('category-id'));
            $('#edit_course_id').val($(btn).data('course-id'));
            $('#edit_teacher_id').val($(btn).data('teacher-id'));
        ...
        $(document).ready(function() {
            ...
            $('#editSessionForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: 'process-edit-session.php', // Backend script
                    type: 'POST',
                    data: $(this).serialize(),
                    dataType: 'json',
