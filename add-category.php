    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            <?php if ($_GET['msg'] == 'success'): ?>
                ...
                alertDiv.textContent = 'Category inserted successfully.';
            <?php elseif ($_GET['msg'] == 'error'): ?>
                alertDiv.classList.add('error-alert');
                alertDiv.textContent = 'There was an error while inserting the category. Please try again.';
            <?php endif; ?>
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="section-block" id="basicform">
                                    <h3 class="section-title text-center">Add Course Category</h3>
                                    ...
                                    <div class="card-body">
                                       <form action="process.php" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <p><?php echo $form->error("category"); ?></p>
                                        </div>
                                        ...
                                        <input type="submit" class="btn btn-primary " value="Add Category" style="width: 30%; ">
                                        </div>
                                    </form>
