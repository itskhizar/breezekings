...
if (isset($_GET['id'])) {
	$id = $_GET['id'];
	$data = $database->getfeesdetails($id);
...
<?php endif; ?>
    ...
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="section-block" id="basicform">
            <h3 class="section-title text-center">Fees Details</h3>
        </div>
...
<?php } ?>
	            ...
	            <h5 class="card-header">Fees Information</h5>
	            ...
	            <div class="card-body">
	                <div class="row">
	                    ...
	                    <div class="col-md-6 mb-3">
	                        <label class="font-weight-bold">Fees Type:</label>
	                        <p class="form-control"><?php echo htmlspecialchars($data['type']); ?></p>
	                    </div>
	                    ...
	                    <div class="col-md-6 mb-3">
	                        ...
	                        <p class="form-control"><?php echo htmlspecialchars($coursedata['course_title']); ?></p>
	                    </div>
	                    ...
	                    <div class="col-md-6 mb-3">
	                        ...
	                        <p class="form-control"><?php echo htmlspecialchars($coursedata['duration']); ?> month</p>
	                    </div>

	                    <!-- Start Time -->
	                    <div class="col-md-6 mb-3">
	                        <label class="font-weight-bold">Monthly:</label>
	                        <p class="form-control"><?php echo htmlspecialchars($data['monthly']); ?></p>
	                    </div>


	                    <div class="col-md-6 mb-3">
	                        <label class="font-weight-bold">Total Amount: <sup>x month</sup></label>
	                        <p class="form-control"><?php echo htmlspecialchars($data['amount']); ?></p>
	                    </div>
