    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="text-center fade-in">
            ...
            <p class="text-xl md:text-2xl max-w-3xl mx-auto mb-8">
                Learn to work independently, handle clients professionally, and build a global freelancing portfolio.
            </p>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            ...
            <p class="text-gray-600 max-w-3xl mx-auto">
                Our freelancing program equips you with the skills, strategies, and confidence to earn online professionally.
            </p>
        </div>
        ...
        <div class="grid md:grid-cols-3 gap-8">
            <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition">
                ...
                <p class="text-gray-600">3-6 months with practical project assignments and mentorship.</p>
            </div>
            <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition">
                <h3 class="text-2xl font-bold mb-3">Mode</h3>
                <p class="text-gray-600">Fully online with live sessions and mentor guidance.</p>
            </div>
            <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition">
                <h3 class="text-2xl font-bold mb-3">Eligibility</h3>
                <p class="text-gray-600">Open to students, graduates, and professionals looking to earn online.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="py-20 bg-gradient-to-r from-purple-50 to-pink-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            <h2 class="text-4xl font-bold text-gray-900 mb-4">Why Join Our Freelancing Program?</h2>
            <p class="text-gray-600 max-w-3xl mx-auto">
                Start your freelancing journey with proper guidance, essential skills, and industry insights to succeed globally.
            </p>
        </div>

        <div class="grid md:grid-cols-3 gap-8">
            <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition">
                <h3 class="text-2xl font-bold mb-3">Skill Development</h3>
                <p class="text-gray-600">Learn in-demand digital skills such as web development, design, and marketing for freelancing marketplaces.</p>
            </div>
            <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition">
                <h3 class="text-2xl font-bold mb-3">Client Handling</h3>
                <p class="text-gray-600">Understand how to approach clients, manage projects, and communicate professionally online.</p>
            </div>
            <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition">
                <h3 class="text-2xl font-bold mb-3">Portfolio Building</h3>
                <p class="text-gray-600">Create a compelling freelancing portfolio to attract global clients and projects.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="py-20 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            ...
            <p class="text-gray-600 max-w-3xl mx-auto">
                Our step-by-step approach ensures practical experience, guiding you from beginner to expert freelancing.
            </p>
        </div>

        <div class="grid md:grid-cols-3 gap-8">
            <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition">
                <h3 class="text-2xl font-bold mb-3">Learn Skills</h3>
                <p class="text-gray-600">Master digital skills like web dev, design, marketing, and more for freelancing success.</p>
            </div>
            <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition">
                <h3 class="text-2xl font-bold mb-3">Project Practice</h3>
                <p class="text-gray-600">Work on real projects to gain confidence and practical experience.</p>
            </div>
            <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition">
                <h3 class="text-2xl font-bold mb-3">Earn & Grow</h3>
                <p class="text-gray-600">Take freelance projects, expand your portfolio, and grow your online income.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="hero-gradient text-white text-center py-24">
    <h2 class="text-5xl font-extrabold mb-6">Kickstart Your Freelancing Career</h2>
    <p class="text-purple-100 mb-10 max-w-3xl mx-auto">
        Apply now to learn how to work independently, acquire clients, and earn globally with confidence.
    </p>
