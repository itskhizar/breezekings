    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            <?php if ($_GET['msg'] == 'success'): ?>
                ...
                alertDiv.textContent = 'New Inventory inserted successfully.';
            <?php elseif ($_GET['msg'] == 'error'): ?>
                alertDiv.classList.add('error-alert');
                alertDiv.textContent = 'There was an error while inserting the inventory. Please try again.';
            <?php endif; ?>
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="section-block" id="basicform">
                                    <h3 class="section-title text-center">Add Inventory</h3>
                                  
                                </div>
                                <div class="card">
                                    <h5 class="card-header">Create New Inventory</h5>
                                    <div class="card-body">
                                  <form action="process.php" method="POST" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <input type="hidden" name="username" value="<?php echo $session->username; ?>">
                                            <label for="company_name" class="col-form-label">Product Name</label>
                                            <input type="text" name="product_name" class="form-control" placeholder="Enter product name">
                                            <p><?php echo $form->error("product_name"); ?></p>
                                        </div>

                                        <div class="form-group">
                                            <label for="payment_date" class="col-form-label">Source</label>
                                            <input type="text" name="source" class="form-control"  placeholder="Enter source">
                                            <p><?php echo $form->error("source"); ?></p>
                                        </div>

                                        <div class="form-group">
                                            <label for="amount_paid" class="col-form-label">Warehouse</label>
                                            <input type="text" name="warehouse" class="form-control" placeholder="Enter warehouse">
                                            <p><?php echo $form->error("warehouse"); ?></p>
                                        </div>

                                        <div class="form-group">
                                            <label for="payment_method" class="col-form-label">Picture</label>
                                            <input type="file" name="picture" class="form-control" placeholder="Enter picture">
                                            <p><?php echo $form->error("picture"); ?></p>
                                        </div>

                                        <div class="form-group">
                                            <label for="date" class="col-form-label">Date</label>
                                            <input type="date" name="date" class="form-control" placeholder="Enter date">
                                            <p><?php echo $form->error("date"); ?></p>
                                        </div>
                                       ...
                                       <div class="text-center">
                                                                        <input type="submit" class="btn btn-danger " value="Add Inventory" style="width: 30%; ">
                                                                        </div>
                                    </form> 
